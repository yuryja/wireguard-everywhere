...
- 🚀 **Quick Installation**: One command to set up a complete WireGuard server
- 🔒 **Secure by Default**: Uses modern cryptography and secure defaults
- 🐳 **Container Support**: Works on both bare metal and containerized environments (LXC, Docker)
- 🎯 **Multiple DNS Options**: Google, Cloudflare, Quad9, AdGuard, Gcore, or custom DNS
- 📱 **QR Code Generation**: Instant QR codes for mobile client setup
- 🔄 **Easy Client Management**: Add, remove, and manage clients interactively
- 🌍 **Multi-Distribution**: Supports Ubuntu, Debian, AlmaLinux, Rocky Linux, CentOS, and Fedora
...
### Features
- 📊 **Dashboard**: View active clients and statistics
- ➕ **Client Management**: Create, delete, enable, and disable clients
